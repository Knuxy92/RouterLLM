// Pure-TypeScript HMAC-SHA256. `crypto.subtle` only exists in secure
// contexts (HTTPS / localhost), and the admin console is routinely opened
// over plain http://<lan-ip> — so the proof computation cannot rely on it.
// SHA-256 core follows FIPS 180-4; HMAC construction follows RFC 2104.
// Correctness is pinned by the RFC 4231 vectors in hmac.test.ts.
