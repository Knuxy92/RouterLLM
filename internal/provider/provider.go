...
func routingRules() []routingRule {
	rules := []routingRule{
		{"claude-opus-4-8", []routeSpec{{"freemodel-cc", "claude-opus-4-8"}, {"agentrouter", "claude-opus-4-8"}}},
		{"claude-opus-4-7", []routeSpec{{"freemodel-cc", "claude-opus-4-7"}, {"agentrouter", "claude-opus-4-7"}}},
		{"claude-opus-4-6", []routeSpec{{"freemodel-cc", "claude-opus-4-6"}, {"agentrouter", "claude-opus-4-6"}}},
		{"gpt-5.5", []routeSpec{{"freemodel-api", "gpt-5.5"}, {"agentrouter", "gpt-5.5"}}},
